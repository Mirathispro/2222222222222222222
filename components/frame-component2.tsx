...
const FrameComponent2: NextPage<FrameComponent2Type> = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch flex flex-row items-start justify-center py-0 pr-5 pl-[49px] box-border max-w-full text-left text-base text-white font-display-text-header-big mq1400:pl-6 mq1400:box-border ${className}`}
    >
      <div className="w-[1636px] grid flex-row items-start justify-start gap-[20px] max-w-full grid-cols-[repeat(4,_minmax(295px,_1fr))] z-[1] mq925:grid-cols-[minmax(295px,_1fr)] mq1400:justify-center mq1400:grid-cols-[repeat(2,_minmax(295px,_512px))]">
        <NFTCard
          nFTPicture="/nft-picture@2x.png"
          prices="321"
          userProfile="/user-profile@2x.png"
        />
        <NFTCard
          nFTPicture="/nft-picture@2x.png"
          prices="24"
        ...
        <div className="[backdrop-filter:blur(20px)] rounded-mini [background:linear-gradient(147.75deg,_rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.05))] flex flex-col items-start justify-start pt-0.5 px-3 pb-[13px] box-border gap-[39px] max-w-full mq450:gap-[19px]">
          ...
          <div className="flex flex-row items-start justify-start pt-0 px-[22px] pb-1.5 text-6xl">
            <div className="flex flex-row items-start justify-start gap-[14px]">
              ...
              <div className="flex flex-col items-start justify-start gap-[2px]">
                <div className="h-[31px] relative tracking-[0.05em] capitalize inline-block whitespace-nowrap z-[1] mq450:text-xl">
                  Floki Mentor
                </div>
          ...
          <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[18px] pl-3.5 box-border max-w-full">
            <div className="flex-1 flex flex-col items-start justify-start gap-[30px] max-w-full">
              ...
              <div className="self-stretch flex flex-row items-start justify-between py-2.5 px-0 relative gap-[20px] z-[1] text-center text-lg mq450:flex-wrap">

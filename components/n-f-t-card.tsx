    ...
    >
      ...
      <div className="self-stretch rounded-mini flex flex-row items-start justify-end pt-0 px-0 pb-[211px] box-border bg-[url('/nft-picture@2x.png')] bg-cover bg-no-repeat bg-[top] max-w-full z-[1]">
        <img
          ...
          src={nFTPicture}
        />
        <div className="[backdrop-filter:blur(20px)] rounded-tl-none rounded-tr-mini rounded-br-none rounded-bl-mini [background:linear-gradient(147.75deg,_rgba(255,_255,_255,_0.1),_rgba(255,_255,_255,_0.05))] flex flex-row items-start justify-start py-[15px] px-5 z-[1]">
      ...
      <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[19px] pl-3.5 box-border max-w-full text-6xl">
        <div className="flex-1 flex flex-col items-start justify-start gap-[45px] max-w-full mq450:gap-[22px]">
          <div className="flex flex-row items-start justify-start py-0 px-2">
            <div className="flex flex-row items-start justify-start gap-[14px] z-[1]">
              <img
              ...
              <div className="flex flex-col items-start justify-start gap-[2px]">
                <div className="h-[31px] relative tracking-[0.05em] capitalize inline-block whitespace-nowrap mq450:text-xl">
                  Floki Mentor
                </div>
                <div className="relative text-sm tracking-[0.05em] capitalize font-lato inline-block min-w-[69px]">
                  By @ User
                </div>
              </div>
            </div>
          </div>
          <div className="self-stretch flex flex-col items-start justify-start gap-[30px] max-w-full z-[1] text-base">
            ...
            <div className="self-stretch flex flex-row items-start justify-between py-2.5 px-0 relative gap-[20px] text-center text-lg mq450:flex-wrap">
              ...
              <div className="flex flex-col items-start justify-start pt-2 px-0 pb-0">
                <div className="relative capitalize font-medium inline-block min-w-[75px] z-[2]">
                  buy now
                </div>
              </div>
